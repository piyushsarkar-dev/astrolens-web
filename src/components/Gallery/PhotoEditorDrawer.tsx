...
export const PhotoEditorDrawer = ({
  ...
  return (
    <aside
      className="fixed inset-y-0 right-0 z-50 flex w-full max-w-sm flex-col bg-[#141517]/95 backdrop-blur-2xl border-l border-white/10 shadow-2xl text-foreground animate-in slide-in-from-right duration-200"
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-4 gap-2">
            <button
              ...
              className="flex flex-col items-center justify-center gap-1.5 rounded-2xl bg-white/[0.04] hover:bg-white/[0.08] p-3 text-white border border-white/5 transition cursor-pointer"
            ...
            <button
              ...
              className={`flex flex-col items-center justify-center gap-1.5 rounded-2xl p-3 border transition cursor-pointer ${
                edits.flipH
                  ...
                  : "bg-white/[0.04] hover:bg-white/[0.08] border-white/5 text-white"
              }`}
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between text-xs">
              ...
              <span className="text-white font-mono">{edits.brightness ?? 100}%</span>
            </div>
            <input
              type="range"
              min="50"
              ...
              className="w-full accent-sky h-1.5 bg-white/10 rounded-lg cursor-pointer"
            />
          </div>
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between text-xs">
              ...
              <span className="text-white font-mono">{edits.contrast ?? 100}%</span>
            </div>
            <input
              type="range"
              min="50"
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between text-xs">
              ...
              <span className="text-white font-mono">{edits.saturation ?? 100}%</span>
            </div>
            <input
              type="range"
              min="0"
                ...
                <button
                  ...
                  className={`rounded-xl px-3 py-2 text-xs font-medium border transition text-center cursor-pointer ${
                    active
                      ...
                      : "bg-white/[0.04] text-white/80 border-white/5 hover:bg-white/[0.08]"
                  }`}>
                  {f.label}
                </button>
              );
      ...
      <div className="flex items-center justify-between gap-3 border-t border-white/10 p-4">
        <button
          type="button"
          onClick={handleReset}
          className="flex items-center gap-1.5 rounded-full px-4 py-2 text-xs font-medium text-white/70 hover:bg-white/10 transition cursor-pointer">
          <Undo2 size={15} />
          <span>Reset</span>
        </button>
